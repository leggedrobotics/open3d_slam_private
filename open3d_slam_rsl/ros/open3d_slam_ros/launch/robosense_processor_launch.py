...
def generate_launch_description():
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            'cloud_topic', default_value='/rslidar/points',
            description='Input point cloud topic'
        ),
        DeclareLaunchArgument(
            'pose_topic', default_value='/graph_msf/est_odometry_odom_imu',
        ...
        # Robosense Processing Node
        Node(
            package='open3d_slam_ros',
            executable='robosense_processing_node',
            name='robosense_processor',
            output='screen',
            parameters=[{
