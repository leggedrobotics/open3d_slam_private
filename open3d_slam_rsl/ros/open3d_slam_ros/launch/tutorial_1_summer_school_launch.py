...
def generate_launch_description():
    ...
    declared_args = [
        ...
        DeclareLaunchArgument('parameter_filename', default_value='tutorial_1_param_summer_school.lua'),
        ...
        # Bag play options
        DeclareLaunchArgument('bag_path', default_value='/home/ttuna/colcon_ws/src/smb_bag_stb_outdoor_3_filt.mcap', description='Bag file to play'),
