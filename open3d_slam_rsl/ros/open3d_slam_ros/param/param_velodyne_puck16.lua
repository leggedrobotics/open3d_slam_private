...
params.map_initializer.pcd_file_path = "/data/10cm_voxelized_whole_map.pcd"
params.map_initializer.is_initialize_interactively = true
params.map_initializer.init_pose.x = -38.5
params.map_initializer.init_pose.y = 227.0
params.map_initializer.init_pose.z = -1.57
params.map_initializer.init_pose.roll = 0.0
params.map_initializer.init_pose.pitch = 0.0
params.map_initializer.init_pose.yaw = -125.0
...
params.submap.max_num_points = 15000000
