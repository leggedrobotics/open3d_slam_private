...
params.mapper_localizer.scan_to_map_registration.scan_processing.scan_cropping.cropping_radius_max = 35.0 --We don't want to crop the scans.
params.mapper_localizer.scan_to_map_registration.icp.max_correspondence_dist = 2.0 --NOT USED RIGHT NOW
params.mapper_localizer.scan_to_map_registration.icp.knn = 20 --Currently only used for surface normal estimation.
...
params.map_initializer.pcd_file_path = "/home/tutuna/Videos/aesch_2_3/tower-5cm_normals_up_ready.ply"
params.map_initializer.is_initialize_interactively = false

-- aesch 2 / 3

-- params.map_initializer.init_pose.x = -3.10
-- params.map_initializer.init_pose.y = 106.8
-- params.map_initializer.init_pose.z = 0.05
-- params.map_initializer.init_pose.roll = 180.0
...
params.map_initializer.init_pose.x = -1.96
params.map_initializer.init_pose.y = 106.44
params.map_initializer.init_pose.z = 0.01
params.map_initializer.init_pose.roll = 180.0
params.map_initializer.init_pose.pitch = 0.0
params.map_initializer.init_pose.yaw = -41.8
...
params.map_builder.scan_cropping.cropping_radius_max = 35.0
...
params.dense_map_builder.scan_cropping.cropping_radius_max = 35.0
