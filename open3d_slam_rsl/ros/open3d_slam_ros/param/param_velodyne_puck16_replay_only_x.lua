...
params.mapper_localizer.scan_to_map_registration.scan_processing.voxel_size = 0.1  --Tunnel loves 0.1
...
params.mapper_localizer.scan_to_map_registration.icp.reference_cloud_seting_period = 0.1 --sec --Tunnel loves 0.01
...
--SUBMAP
params.submap.submap_size = 20.0 --meters --Tunnel 40  -- FOREST 40
