...
params.mapper_localizer.scan_to_map_registration.icp.max_correspondence_dist = 200000000.0 --NOT USED RIGHT NOW
params.mapper_localizer.scan_to_map_registration.icp.knn = 10000000 --Currently only used for surface normal estimation.
params.mapper_localizer.scan_to_map_registration.icp.max_distance_knn = 20000000.0 --Currently only used for surface normal estimation.
